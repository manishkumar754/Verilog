...
HD_PWD='C:/Users/preet/Desktop/Industrial_project/axi/axi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_des_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_des_wrapper.tcl -notrace
